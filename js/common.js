$(document).ready(function(){
    ...
    $(document).on('click','.popup_save1',function()
    {
        ...
        var url1='http://localhost/matro/quick_result';
        var data={id:id};
        $.ajax({
            url:completeURL(url), 
            data:data,          
    ...
    $(document).on('click','.send_mail' , function(){
        var deleteDiv = $(this);
        var id = deleteDiv.attr('rel');
        var send_id = deleteDiv.attr('send_id');
        var url = deleteDiv.attr('rev');
    ...
    $(document).on('change','.fetch_report',function(){  
        ...
        $.ajax({
            type:'POST',
            url:completeURL(url),
            data:{val1:val1,val2:val2,status:status},
            dataType:'html',
            success:function(data)
            {      
                $('.report_div').html(data);
