...
<head>
<meta charset="utf-8">
<title>Shivbandh | Subscribe</title>
...
<div class="page-container">
	...
	<div class="page-content">
		<div class="container">
			...
			<?php if(isset($subscribe_data) && !empty($subscribe_data))
			{ ?> 
				<div class="portlet box green">
					...
					<div class="portlet-body">
						<table class="table table-striped table-bordered table-hover masterTable" >
							...
							<tbody> 
								<?php $i = 1;
								foreach ($subscribe_data as $key) { ?>
									<tr class="odd gradeX">
										<td><?php echo $i++;?></td>
										<td><?php echo $key->email; ?></td>
										<td style="text-align:center;" align="8%">
											<span style="cursor: pointer;" class="tooltips deleteRecord" rel="<?php echo(isset($key->subscribe_id) && !empty($key->subscribe_id))?$key->subscribe_id:''?>" rev="delete_subscribe" title="Delete Record">
