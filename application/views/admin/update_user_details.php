															...
															<div class="form-group">
																...
																<div class="radio-list">
																	<label class="radio-inline">
																		<input type="radio" name="gender1" id="male" value="Male"  <?php echo(!isset($customer_data->gender))?'checked':'' ?>  <?php echo(isset($customer_data->gender) && !empty($customer_data->gender) && ($customer_data->gender=='Male'))?'checked="checked"':'';?>> Male 
																	</label>
																	<label class="radio-inline">
																		<input type="radio" name="gender1" id="female" value="Female"  <?php echo(isset($customer_data->gender) && !empty($customer_data->gender) && ($customer_data->gender=='Female'))?'checked="checked"':'';?> > Female
																	</label>
																</div>
															</div>
														</div>
