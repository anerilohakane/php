...
<html lang="en">
<head>
<title>Shivbandhan | Failure</title>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('assets/site1/images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Failure</h2>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="form-group">
            <p style="text-align: center;"> Payment Failed Please try again later..!  </p>
          </div> 
          <div class="row">
