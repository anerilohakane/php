...
<html lang="en">
<head>
<title>Shivbandhan | Terms & Condition</title>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('assets/site1/images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading"> Terms & Condition</h2>
  ...
  <section class="main-container">
    <div class="container">
      <div class="section text-center">
        <h3 class="section-heading" style="margin-top: -90px;">Shivbandhan  Terms & Condition</h3>
      </div>
      <section class="">
            ...
            <div class="row">
              <div class="col-md-12" >
                <div class="single-block">
                  <div class="blog-dtl">
                    <p class="blog-dis"><?php echo (isset($term_condition_details->term_condition_desc) && !empty($term_condition_details->term_condition_desc))?$term_condition_details->term_condition_desc:'';?></p>
                  </div>
                </div>
              </div>
            </div>
