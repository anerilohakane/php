                ...
                <div class="pricing-table-block">
                  ...
                  <div class="pricing-table-list">
                    ...
                    <div class="pricing-table-btn">
                      ...
                      { ?>
                      <?php /*<form action="javascript:void(0);"  method="post"  >
                        ...
                        <a href="<?php echo base_url()?>book_online/<?php echo(isset($key->membership_id) && !empty($key->membership_id))?$key->membership_id:'0';?>" class="btn btn-default">Pay Now</a>
                      <?php /*</form>*/ ?>
                      <?php } else 
                      { ?>
