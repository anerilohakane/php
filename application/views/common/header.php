...
<div class="page-header">
	<div class="page-header-top">
		<div class="container">
			<div class="page-logo">
				<a href="<?php echo base_url();?>admin"><img src="<?php echo base_url();?>assets/admin/layout3/img/logo-default.png" style=" width: 29%; margin-top: 1px;" alt="logo" class="logo-default"></a>
			</div>
