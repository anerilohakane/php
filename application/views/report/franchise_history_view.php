<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift"></i>Transcastion History
		</div> 
	...
	<div class="portlet-body">
		<table class="table table-striped table-bordered table-hover masterTable" >
			...
			<span> <b>Total Amount: </b> <?php echo (isset($total_transcation_data[0]->total_amount) && !empty($total_transcation_data[0]->total_amount))?$total_transcation_data[0]->total_amount:'-';?></span>
	</div>
</div>