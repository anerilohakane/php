...
<head>
<meta charset="utf-8">
<title>Shivbandhan | Franchise History</title>
				...
				<div class="col-md-12">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Franchise History
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group date date1" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
												<input type="text" name="fromDate" class="form-control val1 fetch_report" data-url="get_franchise_history" readonly >		
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group date date1" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
												<input type="text" name="toDate" class="form-control val2 fetch_report" data-url="get_franchise_history" readonly >
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="control-label">Select Franchise<span class="required" aria-required="true">*</span></label>
											<select class="form-control select2me status fetch_report" data-url="get_franchise_history" name="status" >
												<option value="">select</option>
												<?php if(isset($franchise_list) && !empty($franchise_list))
												{ 
													foreach ($franchise_list as $key) 
													{ ?>
														<option value="<?php echo $key->user_id;?>"><?php echo isset($key->user_fname) && !empty($key->user_fname)?$key->user_fname.' '.$key->user_lname:'-';?></option>
													<?php }															
												} ?>														
											</select>
										</div> 
