...
class Site_controller extends CI_Controller {	
    ...
    public function register()
    {
        ...
        $data = array('profile_code'=>$profile_code,'f_name'=>$f_name,'m_name'=>$m_name,'l_name'=>$l_name,'email'=>$email_id,'mobile'=>$mobile_no,'password'=>$password,'otp'=>$otp,'profile_for'=>$profile_for,'dob'=>$dob1,'gender'=>$gender,'term_condition'=>$term_condition);
        //print_r($data);
    ...
    public function verify_mobile()
    {
        ...
        if(isset($email_data) && !empty($email_data) && $email_data->otp==$otp)
        {
            ...
            sendSms($email_data->mobile,$message);
    ...
    public function save_site_forgot_pass()
    {
        ...
        $userData = $this->common_model->selectDetailsWhr('tbl_customer','email',$email);
    ...
    { 
        ...
        $data = array('customer_id'=> $customer_id,'customer_name'=> $customer_name,'mobile'=> $mobile,'email'=> $email,'membership_amt'=> $membership_amt,'membership_plan'=> $plan,'pay_type'=>'Online','membership_validity'=>$membership_validity,'payment_mode'=>'online','transcation_id'=>$transaction_id);
        ...
        $this->payumoney_lib->onlinePayment($customer_name,$data); 
    }
    ...
    {  
        ...
        else
        {
            ...
            if($result)
            {
                ...
                sendSms($userdata1->mobile,$message);
