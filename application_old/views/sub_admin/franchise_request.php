...
<head>
<meta charset="utf-8">
<title>Shivbandh | Franchise Request</title>
		...
		<div class="container">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-note"></i>Franchise Request
					</div>
				</div>
				<div class="portlet-body form">
					<form action="save_franchise_request" enctype="multipart/form-data" id="save_franchise_request"  method="post" class="horizontal-form">
						<div class="form-body">						 
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label"> Request From <span class="require" aria-required="true" style="color:red">*</span></label>
										<select class="form-control select2me" name="request_from" >
											<option value="">select</option>
											<?php if(isset($franchise_cust_list) && !empty($franchise_cust_list))
											{ 
												foreach ($franchise_cust_list as $key) 
												{ ?>
													<option value="<?php echo $key->customer_id;?>"><?php echo isset($key->f_name) && !empty($key->f_name)?$key->f_name.' '.$key->m_name.' '.$key->l_name .' ('. $key->profile_code. ')':'-';?></option>
												<?php }															
											} ?>														
										</select>
									</div> 
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label"> Request To<span class="require" aria-required="true" style="color:red">*</span></label>
										<select class="form-control select2me" name="request_to" >
											<option value="">select</option>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label"> Remark <span class="require" aria-required="true" style="color:red">*</span></label>		
										<div class="input-icon right">
											<i class="fa"></i>
											<textarea class="form-control"  rows="3" cols="3" name="remark"  placeholder="News"><?php echo(isset($single_news_data->news_desc) && !empty($single_news_data->news_desc))?$single_news_data->news_desc:''?></textarea>
										</div>												
									</div>
								</div>
							</div>
							...
							<div class="form-actions right">
								...
								<button type="submit" class="btn blue common_save"  rel="<?php echo (isset($single_news_data->news_id) && !empty($single_news_data->news_id))?$single_news_data->news_id:'';?>"><i class="fa fa-check"></i> <?php echo (isset($single_news_data->news_id) && !empty($single_news_data->news_id))?'Update':'Send Request';?>
								</button>
							</div>
						</form>
					</div>
