  ...
  <section id="page-banner" class="page-banner" style="background-image: url('assets/site1/images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Quick Result</h2>
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>">Home</a></li>
            <li class="active">Quick Result</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="main-container" style="background-color: rgb(230, 230, 230);">
    <div class="container">
      <div class="section text-center">
        <h3 class="section-heading" style="margin-top: -70px;">Shivbandhan Quick Result Details</h3>
      </div>
