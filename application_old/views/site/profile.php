              ...
              <div class="tabbable tabbable-custom tabbable-noborder ">
                  ...
                  <div class="tab-content">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                      <div class="form-group">
                                                        ...
                                                        <div class=" "> 
                                                          <select class="form-control select2me mode " name="marital_status">
                                                    ...
                                                    <div class="col-md-4">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                          <i class="fa"></i>
                                                          <input  type="text" class="form-control " name="height" value="<?php echo(isset($customer_data->height) && !empty($customer_data->height))?$customer_data->height:''?>" placeholder=" Enter Height in cm. (ex: 155 )" >
                                                        </div>
                                                      </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                              ...
                                                              <div class="fileinput fileinput-exists" data-provides="fileinput">
                                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                                                  <img src="<?php echo base_url(); ?>uploads/customer_photo/<?php echo (isset($customer_data->customer_photo) && !empty($customer_data->customer_photo))?$customer_data->customer_photo:'user.png'?>" alt=""/>  
                                                                    ...
                                                                    <input type="hidden" class="customer_photo" value="<?php echo (isset($customer_data->customer_photo) && !empty($customer_data->customer_photo))?$customer_data->customer_photo:''?>" name="hidden_customer_photo" id="textfield1" accept="image/*">
                                                                <div>
                                                              ...
                                                              <div class="fileinput fileinput-exists" data-provides="fileinput">
                                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                                                  <img src="<?php echo base_url(); ?>uploads/customer_photo/<?php echo (isset($customer_data->customer_photo1) && !empty($customer_data->customer_photo1))?$customer_data->customer_photo1:'user.png'?>" alt=""/>  
                                                                    ...
                                                                    <input type="hidden" class="customer_photo1" value="<?php echo (isset($customer_data->customer_photo1) && !empty($customer_data->customer_photo1))?$customer_data->customer_photo1:''?>" name="hidden_customer_photo1" id="textfield2" accept="image/*">
                                                                <div>
                                                                  <span class="btn default btn-file">
                                                                  <span class="fileinput-new">
                                                                  Select image </span>
                                                                  ...
                                                                  <a href="javascript:;" class="btn red fileinput-exists remove_image1" data-dismiss="fileinput" onclick="ClearFields2();">
                                                                  Remove </a>
                                                                </div>
                                                              </div>                                 
                                                            <?php } else
                                                              ...
                                                              <div class="fileinput fileinput-exists" data-provides="fileinput">
                                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                                                                  ...
                                                                  <i class="fa fa-file-o" style="font-size: 15px;"></i> 
                                                                    ...
                                                                    <input type="hidden" class="biodata" value="<?php echo (isset($customer_data->biodata) && !empty($customer_data->biodata))?$customer_data->biodata:''?>" name="hidden_biodata" id="textfield3" accept="*">
                                                                <div>
                                                                  <span class="btn default btn-file">
                                                                  <span class="fileinput-new">
                                                                  Select File </span>
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                      <div class="form-group">
                                                        <label class="control-label">Expecteed Education<span class="require" aria-required="true" style="color:red">*</span></label>
                                                          <div class=" "> 
                                                            <select class="form-control select2me " name="expected_education[]" data-placeholder="Choose Expecteed Education" multiple>
                                                              <option value="">select</option>
                                                            <?php if(isset($education_data) && !empty($education_data))
                                                            {
                                                              foreach($education_data AS $key)
                      ...
                      <div class="tab-pane  " id="tab_1_2">
                        ...
                        <div class="tab-content">
                                        ...
                                        <?php $i = 1;
                                          foreach ($incoming_request_data as $key) { ?>
                                            <tr class="odd gradeX">
                                              <td><?php echo $i++;?></td>
                                              <td class="abc">
                                                <img style="width: 50px; height: 50px; border-radius: 50%;" src="./uploads/customer_photo/<?php echo (isset($key->customer_photo) && !empty($key->customer_photo))?$key->customer_photo:'user.png';?>">
                                              </td>
                           ...
                           <div class="tab-pane " id="tab_2_3">
                              <?php if(isset($accepted_request_data_by_user) && !empty($accepted_request_data_by_user))
                              { ?> 
                                <div class="portlet box red">
                                  <div class="portlet-title">
                                    <div class="caption">
                                      <i class="fa fa-gift"></i>Accepted Request By User
                                    </div> 
                                  </div> 
                                  <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover masterTable" >
                                      ...
                                      <tbody> 
                                        <?php $i = 1;
                                          foreach ($accepted_request_data_by_user as $key) { ?>
                                            <tr class="odd gradeX">
                                              <td><?php echo $i++;?></td>
                                              <td class="abc">
                                                <img style="width: 50px; height: 50px; border-radius: 50%;" src="./uploads/customer_photo/<?php echo (isset($key->customer_photo) && !empty($key->customer_photo))?$key->customer_photo:'user.png';?>">
                                             ...
                                             <td align="center">
                                                 <a class="btn btn-success btn-xs " href="<?php echo base_url();?>profile_details/<?php echo (isset($key->customer_id) && !empty($key->customer_id))?$key->customer_id:'';?>"><i class="fa fa-search" aria-hidden="true"></i> View</a>
                                                 <a class="btn btn-danger btn-xs tooltips send_request" rev="cancel_request" rel="<?php echo(isset($key->request_id) && !empty($key->request_id))?$key->request_id:''?>" data-original-title="Delete Record" data-placement="top" href="javascript:void(0);"><i class="fa fa-trash-o" aria-hidden="true"></i> Cancel</a>
                                                 <a class="btn btn-primary btn-xs tooltips " href="<?php echo base_url();?>chat_details/<?php echo (isset($key->customer_id) && !empty($key->customer_id))?$key->customer_id:'';?>" target="_blank"><i class="fa fa-comments-o" aria-hidden="true"></i> Chat</a>
                                              </td>
                                            </tr>
                                          <?php } ?>
                      ...
                      <div class="tab-pane " id="tab_1_4">
                        <?php if(isset($inbox_data) && !empty($inbox_data))
                        { $cnt=count($inbox_data);
                          for($i=0;$i < $cnt;$i++) 
                          { ?>
                             <div class="col-md-8" style=" padding: 10px;">
                                  <div class="media-left">
                                    <a href="<?php echo base_url();?>chat_details/<?php echo isset($inbox_data[$i]['customer_id'])&& !empty($inbox_data[$i]['customer_id'])?$inbox_data[$i]['customer_id']:'';?>"><img src="<?php echo base_url();?>uploads/customer_photo/<?php echo (isset($key->customer_photo) && !empty($key->customer_photo))?$key->customer_photo:'user.png';?>"  class="img-responsive " alt="profile" style="border-radius: 150px; padding: 5px; height: 65px; width: 65px;" ></a>
                                  </div>
                                  <div class="media-body">
                                    <div class="date" style="padding: 8px;"><?php echo isset($inbox_data[$i]['f_name'])&& !empty($inbox_data[$i]['f_name'])?$inbox_data[$i]['f_name'].' '.$inbox_data[$i]['m_name'].' '.$inbox_data[$i]['l_name']:'';?></div>
                                    <div class="date" style="padding-left: 8px;"><?php echo isset($inbox_data[$i]['profile_code'])&& !empty($inbox_data[$i]['profile_code'])?$inbox_data[$i]['profile_code']:'';?></div>
                                  </div>
                                  <div class="media-body">
                                    <div class="date" style="padding: 8px;"><?php echo isset($inbox_data[$i]['messae'])&& !empty($inbox_data[$i]['messae'])?$inbox_data[$i]['messae']:'';?></div>
                                      <div class="date" style="padding: 8px;"><?php echo isset($inbox_data[$i]['modified_on'])&& !empty($inbox_data[$i]['modified_on'])?date('d-M-Y h:i: A',strtotime($inbox_data[$i]['modified_on'])):'';?></div>
                                  </div>
                                </div>
                          <?php }
                        }
