          ...
          <div class="col-sm-6">
            <div class="top-detail text-right">
              <ul style="margin-top: 10px; margin-left: -150px;">
                ...
                { ?>
                  <li><a href="javascript:void(0);" class="popup_save1" rev="search_matches">Search</a></li>
                <?php }
                else
                { ?>
                    <li><a href="javascript:void(0)" data-toggle="modal" data-target="#login-model">Search</a></li>
                <?php } ?>
                <?php if(isset($customer_id) && !empty($customer_id))
                { ?>
                ...
                {?>
                  <li><a href="javascript:void(0)" data-toggle="modal" data-target="#register-model">Register</a></li>
                ...
                <?php } 
                  ...
                  <li><a href="javascript:void(0)" data-toggle="modal" data-target="#login-model">Login</a></li>
                <?php } ?>  
              ...
              <div class="modal-body login-model-body text-center">
                <form id="login-form" action="site_login" method="post">
                  <div class="form-group">
                    <input type="email" class="form-control" name="email_id" id="login_email" placeholder="Enter Your Email"/>
                ...
                <form id="register-form" action="register" method="post">
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="email" class="form-control" name="email_id" id="reg_email" placeholder="Enter Your Email"/>
                      </div>
                      <div class="form-group">
