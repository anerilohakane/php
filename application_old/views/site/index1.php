...
<link href="<?php echo base_url();?>assets/site/css/menumaker.css" rel="stylesheet" type="text/css"/> 
<link href="<?php echo base_url();?>assets/site/css/owl.carousel.css" rel="stylesheet" type="text/css"/> 
<link href="<?php echo base_url();?>assets/site/css/magnific-popup.css" rel="stylesheet" type="text/css"/> 
<link href="<?php echo base_url();?>assets/global/css/components-rounded.css" id="style_components" rel="stylesheet" type="text/css">
<link href="<?php echo base_url();?>assets/site/css/flaticon.css" rel="stylesheet" type="text/css"/> 
<link href="<?php echo base_url();?>assets/site1/css/style.css" rel="stylesheet" type="text/css"/> 
<link href="<?php echo base_url();?>assets/site/css/stucture.css" rel="stylesheet" type="text/css"/> 
  ...
  <section class="ptb120">
    <div class="container">
      <div class="section text-center">
        <h3 class="section-heading">Top Inspirations Couple</h3>
      </div>
      <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
              <div class="upcoming-wedding-block">
                <div class="upcoming-wedd-img">
                  <a href="#"><img src="<?php echo base_url();?>uploads/inspiral/<?php echo (isset($key->photo) && !empty($key->photo))?$key->photo:'';?>" class="img-responsive" alt="Shivbandhan Story"></a>
                </div>
          ...
          { ?>
            <div class="item testimonial-block text-center">
              ...
              <div class="testimonial-client-img">
                <img src="<?php echo base_url();?>uploads/success_story/<?php echo (isset($key->photo) && !empty($key->photo))?$key->photo:'';?>" class="img-responsive" alt="testimonial" style="height: 100px; width: 100px;">
              </div>
