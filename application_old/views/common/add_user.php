		...
		<div class="container">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form">
					<form action="save_user" enctype="multipart/form-data" id="save_user"  method="post" class="horizontal-form">
						<div class="form-body">
										...
										<div class="input-icon ">          						
											<select class="form-control select2me" name="role_id">
												...
												<?php if(isset($role_data) && !empty($role_data))
												{
													...
													{ ?>
														<option value="<?php echo $key->role_id?>" <?php echo (isset($single_user->role_id) && !empty($single_user->role_id) && ($single_user->role_id==$key->role_id))?'selected="selected"':'';?>><?php echo $key->role_name;?></option>
													<?php }															
												} ?>														
											</select>
										</div>
								...
								foreach ($user_data as $key) { ?>
									<tr class="odd gradeX">
										...
										<td style="text-align:center;" align="8%">
											...
											{ ?>
												<span style="cursor: pointer;" class="tooltips editRecord" rel="<?php echo(isset($key->user_id) && !empty($key->user_id))?$key->user_id:''?>" rev="edit_user" title="Edit Record">
													<i class="fa fa-edit"></i>
												</span>
												<span style="cursor: pointer;" class="tooltips deleteRecord" rel="<?php echo(isset($key->user_id) && !empty($key->user_id))?$key->user_id:''?>" rev="delete_user" title="Delete Record">
