							...
							<tbody> 
								...
								foreach ($contact_data as $key) { ?>
									<tr class="odd gradeX">
										...
										<td><?php echo $key->contact_phone; ?></td>
										<td><?php echo $key->contact_email; ?></td>
										<td><?php echo $key->contact_subject; ?></td>
										<td><?php echo $key->contact_message; ?></td>
										<td style="text-align:center;" align="8%">
											<span style="cursor: pointer;" class="tooltips deleteRecord" rel="<?php echo(isset($key->contact_id) && !empty($key->contact_id))?$key->contact_id:''?>" rev="delete_contact" title="Delete Record">
