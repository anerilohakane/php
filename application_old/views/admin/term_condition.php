...
<head>
	<meta charset="utf-8"/>
	<title>Shivbandhan | Term & Condition</title>
			...
			<div class="page-content">
				<div class="container">
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo base_url();?>add_product">Term & Condition</a>
						...
						<div class="col-md-12">
							<div class="portlet box green">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-gift"></i>Term & Condition
									</div>
									<div class="tools">
								...
								<div class="portlet-body form">
									<form action="save_term_condition" enctype="multipart/form-data" id="save_term_condition"  method="post" class="horizontal-form">
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<div class="input-icon "><i class="fa"></i>
															<textarea class="form-control summernote" placeholder="Products Description" rows="6" name="term_condition_desc"><?php echo(isset($term_condition_data->term_condition_desc) && !empty($term_condition_data->term_condition_desc))?$term_condition_data->term_condition_desc:''?></textarea>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="form-actions right">
											...
											<button type="submit" class="btn blue common_save" rel="<?php echo (isset($term_condition_data->term_condition_id) && !empty($term_condition_data->term_condition_id))?$term_condition_data->term_condition_id:'';?>"><i class="fa fa-check"></i> <?php echo (isset($term_condition_data->term_condition_id) && !empty($term_condition_data->term_condition_id))?'Update':'Save';?></button>
										</div>		
									</form>
								</div>
							</div>
